...
-- 4. 插入商品数据
INSERT INTO `product` (`user_id`, `title`, `description`, `price`, `category_id`, `status`, `view_count`) VALUES
(1, 'iPhone 13 Pro', '99新，使用半年，无划痕，全套配件', 6999.00, 2, 1, 100),
...
(1, '/images/products/iphone1.jpg', 1),
...
-- 6. 插入订单数据
INSERT INTO `orders` (`order_no`, `buyer_id`, `seller_id`, `product_id`, `price`, `status`, `address_id`) VALUES
('202404290001', 2, 1, 1, 6999.00, 4, 3),
('202404290002', 3, 1, 2, 12999.00, 3, 4),
('202404290003', 1, 2, 3, 599.00, 2, 1);

-- 7. 插入评价数据
INSERT INTO `comment` (`order_id`, `user_id`, `product_id`, `content`, `rating`) VALUES
(1, 2, 1, '手机很好用，卖家很诚信', 5),
...
-- 10. 插入系统通知数据
INSERT INTO `system_notification` (`user_id`, `content`, `is_read`) VALUES
(1, '您的商品已成功上架', 1),
(2, '您有一个新订单待处理', 0),
(3, '您的订单已发货', 1);

-- 11. 插入推荐数据
INSERT INTO `recommendation` (`user_id`, `product_id`) VALUES
(1, 2),
(1, 4),
(2, 1),
(2, 3),
